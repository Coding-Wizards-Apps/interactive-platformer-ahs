export default class Game {
  ...
  async setup(clusters) {
    ...
    for (let cluster of clusters) {
      ...
      platform.x = cluster.pixels[0].coordX * this.config.width /100;
      platform.y = cluster.pixels[0].coordY * this.config.height /100;
    }
  }
  ...
  draw() {
    ...
    if (this.player.collide(this.door)) {
      ...
      let highscore = Math.floor((endTime - this.startTime) / 1000); // startTime should be defined when the game starts
